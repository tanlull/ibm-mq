 ...
 *
 */
public class JmsGetDebt {

	// System exit status value (assume unset value to be 1)
	private static int status = 1;

	// Create variables for the connection to MQ
	private static final String HOST = "10.32.23.134"; // Host name or IP address
	private static final int PORT = 3414; // Listener port for your queue manager
	private static final String CHANNEL = "NT.DEBT.SVRCONN"; // Channel name
